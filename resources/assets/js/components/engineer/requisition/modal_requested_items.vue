...
<template>
   <div class="modal fade" id="modal-requested-items" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
...
<style type="text/css">
    ...
    #tbl-requested-items td {
      padding: 2px;
      text-align: center;
    }
    #tbl-requested-items th {
      padding: 2px;
      text-align: center;
    }
    .td-extension {
        padding: 0px; font-size: 10px; color: white;
    }
</style>
<script>
